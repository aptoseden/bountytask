...
# submit
aptos move run --function-id local::bountytask::submit_task --args u64:1 --profile bob

aptos move run --function-id local::bountytask::confirm_task --args u64:1 --args bool:true --args string:'well done' --profile alice
